...
builder.Services.AddSwaggerGen(o =>
{
    ...
    // Honour C# nullable reference type annotations: non-nullable properties become
    // required in the OpenAPI schema. Without this openapi-typescript emits `field?: T`
    // for everything, causing type errors on the frontend.
